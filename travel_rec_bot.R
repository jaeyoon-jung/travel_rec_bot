...
linkend2 <- flickr2 %>% html_nodes(css = "div.photo-list-photo-interaction > a") %>% .[[2]] %>% html_attr("href") ##getting the href from the second link
...
linkend3 <- flickr3 %>% html_nodes(css = "div.photo-list-photo-interaction > a") %>% .[[2]] %>% html_attr("href") ##getting the href from the third link
